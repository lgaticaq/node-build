docker build -t node-build:7.1.0 7.1.0
docker tag node-build:7.1.0 lgatica/node-build
docker tag node-build:7.1.0 lgatica/node-build:7.1.0
docker tag node-build:7.1.0 lgatica/node-build:7.1
docker tag node-build:7.1.0 lgatica/node-build:7
docker tag node-build:7.1.0 lgatica/node-build:latest
...
docker build -t node-build:7.1.0-onbuild 7.1.0/onbuild
docker tag node-build:7.1.0-onbuild lgatica/node-build:7.1.0-onbuild
docker tag node-build:7.1.0-onbuild lgatica/node-build:7.1-onbuild
docker tag node-build:7.1.0-onbuild lgatica/node-build:7-onbuild
docker tag node-build:7.1.0-onbuild lgatica/node-build:onbuild
