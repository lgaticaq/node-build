...
- 8.6.0, 8.6, 8, latest ([8.6/Dockerfile](https://github.com/lgaticaq/node-build/blob/master/8.6.0/Dockerfile))
- 8.6.0-onbuild, 8.6-onbuild, 8-onbuild, onbuild ([8.6/onbuild/Dockerfile](https://github.com/lgaticaq/node-build/blob/master/8.6.0/onbuild/Dockerfile))
