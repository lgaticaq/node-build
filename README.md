...
- 8.2.0, 8.2, 8, latest ([8.2/Dockerfile](https://github.com/lgaticaq/node-build/blob/master/8.2.0/Dockerfile))
- 8.2.0-onbuild, 8.2-onbuild, 8-onbuild, onbuild ([8.2/onbuild/Dockerfile](https://github.com/lgaticaq/node-build/blob/master/8.2.0/onbuild/Dockerfile))
